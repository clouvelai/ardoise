...
class BuildDocumentTests(unittest.TestCase):
    ...
    def test_estimate_has_qty_rate_and_no_reconciliation(self) -> None:
        ...
        self.assertIn("Attach the schedule. Keep your invoice in the tool you already use.", html)
        self.assertIn("Attach the schedule. Keep your invoice in the tool you already use.", md)
