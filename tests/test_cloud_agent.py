...
class IngestAndRosterTests(IsolatedHome):
    ...
    def test_status_statement_chips_and_agent_filter(self) -> None:
        ...
        self.assertIn("captain", agent_md)
        self.assertIn("Agent filter captain", agent_md)
        self.assertIn("view only", agent_md)
        self.assertIn("$", agent_md)
        self.assertIn("captain", agent_html)
        self.assertIn("view only", agent_html.lower())
